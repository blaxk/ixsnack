...
46==b||13==b||189==b||109==b||190==b||110==b||v(b)?13==a.which&&(a=d,x(!1,!1,!0),a!=d&&t.value(d,!1,!0)):a.preventDefault();break;case "focusin":x(!0,!1,!0);break;case "focusout":a=d,x(!1,!0,!0),a!=d&&(t.value(d,!1,!0),x(!1,!0,!1))}}function p(a){if(!C){var b=v(a.which);b&&a.preventDefault();"forward"===b?(t.value(d+g.gap,!1,!0),x(!1,!0,!1)):"backward"===b&&(t.value(d-g.gap,!1,!0),x(!1,!0,!1))}}function q(b,c,d){var h={};b="horizontal"===g.axis?b:100-b;h[D]=b+"%";f=b;c?(a.stop().animate(h,g.duration,
function(){e("change",d)}),g.correctEndpoint&&g.duration&&e("mouseUp")):(a.stop().css(h),e("change",d))}function k(a){a<B?a=B:a>F&&(a=F);return a}function E(a){a<h?a=h:a>m&&(a=m);return a}function x(a,c,f){var e=d;a||(e=b.val(),"number"!==typeof Number(e)&&(e=d));e=a=z(e);c&&(e=k(e),c=g.addFirstStr,g.numberFormat&&(e=r.string.numberFormat(e)),e=c+e+g.addLastStr);b.val(e);f&&(d=E(a))}function z(a){var b=Math.round(a/g.gap)*g.gap,c=b-g.gap,d=0;b+g.gap>g.max&&b<a?(d=F-b)&&(b+=Math.round((a-b)/d)*d):
c<g.min&&b>a&&(d=B-b)&&(b+=Math.round((a-b)/d)*d);return b}function v(a){var b=void 0;if(37==a||40==a)b="backward";else if(38==a||39==a)b="forward";return b}function e(a,b){var e="on"+r.string.capitalize(a);c[e].call(t,{type:a,value:t.value(),currentValue:d,isUserInput:b})}var t=this,B,F,h,m,d,f,C=!1,y,D="horizontal"===g.axis?"left":"top";this.initialize=function(){b.on("keydown focusin focusout",l);a.on("keydown",p);return this};this.type=function(a){return a?(y=a,this):y};this.min=function(a,b){return"number"===
typeof a?(B=a,h="number"===typeof b?b:a,this):B};this.max=function(a,b){return"number"===typeof a?(F=a,m="number"===typeof b?b:a,this):F};this.value=function(a,b,c){return"number"===typeof a?(d=g.correctEndpoint&&b||g.snap?z(k(a)):E(a),x(!0,c?!1:!0,!1),q((d-g.min)/(g.max-g.min)*100,b,c),this):z(d)};this.percent=function(a,b){if("number"===typeof a){var c=a;0>c?c=0:100<c&&(c=100);this.value(c/100*(g.max-g.min)+g.min,b);return this}return f};this.enable=function(){C=!1;a.removeClass("disabled");b.attr("disabled",
